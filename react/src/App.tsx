      ...
      <div className="container mx-auto p-4">
          ...
          <div className="flex items-end gap-2">
            <div className="flex-grow">
              ...
              <input
                type="text"
                value={pluginIdText}
                onChange={(e) => setPluginIdText(e.target.value)}
                className="mt-1 block w-full input input-bordered input-sm"
              />
            </div>
        ...
        <div className="space-y-2 mb-4 p-4 border rounded-lg shadow bg-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-2 items-end">
            <div>
              <label className="text-xs">SrcPlgID:</label>
              <input
                type="text"
                value={srcPlugId}
                onChange={(e) => setSrcPlugId(e.target.value)}
                className="input input-bordered input-xs w-full"
              />
            </div>
            <div>
              <label className="text-xs">SrcPrtIdx:</label>
              <input
                type="text"
                value={srcPortIdx}
                onChange={(e) => setSrcPortIdx(e.target.value)}
                className="input input-bordered input-xs w-full"
              />
            </div>
            <div>
              <label className="text-xs">TgtPlgID:</label>
              <input
                type="text"
                value={tgtPlugId}
                onChange={(e) => setTgtPlugId(e.target.value)}
                className="input input-bordered input-xs w-full"
              />
            </div>
            <div>
              <label className="text-xs">TgtPrtIdx:</label>
              <input
                type="text"
                value={tgtPortIdx}
                onChange={(e) => setTgtPortIdx(e.target.value)}
                className="input input-bordered input-xs w-full"
              />
            </div>
            <button
